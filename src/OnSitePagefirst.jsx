  ...
  return (
    <div className="p-6 text-sm font-sans mt-24 bg-gray-50 min-h-screen">
      ...
      <div className="flex relative w-[100%] mb-6 p-1 justify-between items-center">
        ...
        <BiSolidRightArrow className="absolute left-[219px] text-gray-200 text-5xl" />
        <div className="flex-1 py-2.5 px-4 bg-gray-400 text-gray-900 text-center">
          Working
        </div>
        <BiSolidRightArrow className="absolute left-[440px] text-gray-400 text-5xl" />
        <div className="flex-1 py-2.5 px-4 bg-amber-600 text-white text-center">
          On-site Technician
        </div>
        <BiSolidRightArrow className="absolute left-[670px] text-amber-600 text-5xl" />
        <button
