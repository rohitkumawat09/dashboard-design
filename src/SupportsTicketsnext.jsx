  ...
  return (
    <div className="   w-[98%] mx-auto mt-[10%] ">
      ...
      <div className="flex relative w-[98%] mb-4.5 justify-between items-center">
        ...
        <BiSolidRightArrow className="absolute left-[220px] text-blue-500 text-5xl" />
        <div className="flex-1 py-2 px-4 bg-gray-200 text-gray-600 text-center">
          Working
        </div>
        <BiSolidRightArrow className="absolute left-[447px] text-gray-200 text-5xl" />
        <div className="flex-1 py-2 px-4 bg-gray-300 text-gray-600 text-center">
          On-site Technician
        </div>
        <BiSolidRightArrow className="absolute left-[674px] text-gray-300 text-5xl" />
